            ...
            <div className="grid md:grid-cols-2 gap-5 max-w-5xl mx-auto">
              ...
              <div className="bg-card border border-border rounded-3xl p-8 grain-bg shadow-card-hover">
                ...
                <form onSubmit={submitAudit} className="space-y-2.5">
                  ...
                  <input type="url" value={form.url} onChange={(e) => setForm({ ...form, url: e.target.value })} placeholder="https://yourcompany.com (optional)" className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primary transition placeholder:text-muted-foreground" />
